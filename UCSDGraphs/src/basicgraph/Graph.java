...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		List<Integer> numOfEdgesOfEachVertex = new ArrayList<>();
	
		for(int i = 0; i < numVertices; ++i) {
			numOfEdgesOfEachVertex.add(getInNeighbors(i).size() + getNeighbors(i).size());
		}
		
		
		Collections.sort(numOfEdgesOfEachVertex, Collections.reverseOrder());
		return numOfEdgesOfEachVertex;
	}
